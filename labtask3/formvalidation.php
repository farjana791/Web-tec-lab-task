                            ...
                            <fieldset>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" name="" value=""> Movies<br>
							                <input type="checkbox" name="" value=""> Music <br>
							                <input type="checkbox" name="" value=""> Programming<br>
							                <input type="checkbox" name="" value=""> Travelling
                                        </td>
                                    </tr>
                                    <tr>
